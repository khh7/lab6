...
def main():
    ...
    while True:
        ...
        # Elizabeth changes made here
            ...
            og_password = input("Please enter your password to decode: ")
            decoded_password = decode(og_password)
            print(f"Your deocoded password is {decoded_password}")
            menu()
            option = int(input("Please enter an option: "))
        elif option == 3:
            break
